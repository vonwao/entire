...
function *ENTIRE (next) {
	...
	if(status==="ready"){
		yield ENTIRE.middleware.styleist.call(this, ENTIRE.middleware.scriptor.call(this, ENTIRE.middleware.router.call(this, next || noop)));
	}
	else{
...
ENTIRE.setup = function(opts){
	...
	console.log("B", process.env.ENTIRE_EXT);
}
